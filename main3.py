...
# Lista de classes previstas pelo seu modelo (ajuste para o seu caso!)
classes = ['A', 'E', 'I', 'O', 'U']

# Inicializa o Mediapipe
mpHands = mp.solutions.hands
hands = mpHands.Hands(max_num_hands=1)  # Apenas 1 mão
...
while True:
    ...
    letra = None  # Sempre reinicia a letra
    ...
    if results.multi_hand_landmarks:
        for handLms in results.multi_hand_landmarks:
            ...
            if len(pontos) == 21:
                ...
                if dedos == [0, 0, 0, 0, 0]:
                    letra = 'A'
                elif dedos == [0, 0, 0.5, 0.5, 0.5]:
                    letra = 'E'
                elif dedos == [0, 0, 0, 0, 1]:
                    letra = 'I'
                elif dedos == [0, 0, 0, 0, 0] and distPolegar > 50:
                    letra = 'O'
                elif dedos == [0, 1, 1, 0, 1]:
                    letra = 'U'

                # Se as regras não reconheceram, usa IA:
                if letra is None:
    ...
    cv2.imshow("Detector Híbrido de Libras", img)
