from pyfirmata import Arduino,SERVO #servo é o motor q movimenta a mao
import time

# board = Arduino('/dev/ttyACM0')  # Adjust the port as necessary
board = Arduino('COM3')  # Adjust the port as necessary #'COM3' a porta usa que faz contato com o arduino

#pinos do arduino que serao ligados na placa
pin1 = 10   
pin2 = 9
pin3 = 8
pin4 = 7
